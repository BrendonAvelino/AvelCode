	...
	<div class="linha">
		<div class="col-md-3">
			<div class="mb-3">
				...
				<input name="titulo" type="text" class="form-control" placeholder="Título Serviços" value="<?php echo $titulo_servicos ?>" obrigatório>
			</div>
		</div>
		...
		<div class="col-md-7 col-9">
			<div class="mb-3">
				...
				<input name="subtitulo" type="text" class="form-control" placeholder="Subtítulo se Houver" value="<?php echo $subtitulo_servicos ?>">
			</div>
		</div>
...
<h>
<a class="btn btn-secondary" onclick="inserir()" class="btn btn-primary btn-flat btn-pri"><i class="bi bi-plus-lg"></i> Novo Serviço</a>
...
<div class="col-md-12">
					...
					<div class="linha">
						...
						<div class="col-md-8 col-8">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Imagem (500x500)</label>
...
<script type="texto/javascript">
	...
	$("#form-config").submit(function(){
		...
		$.ajax({
			url: "scripts/salvar-servicos.php",
			digite: 'POST',
